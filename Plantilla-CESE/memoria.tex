...
\juradoUNO{Esp. Ing. Leonardo carducci (filiación)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
...
Este proyecto consiste en diseñar e implementar un dispositivo de adquisición de datos con múltiples entradas para aplicaciones IoT en ambientes industriales para la empresa Tecrea S.A.S.
El dispositivo tiene una arquitectura modular que le permite incorporar nuevas funcionalidades y puede operar con protocolos inalámbricos como SigFox y Lora.

La importancia de este proyecto se enfoca en que los procesos sean menos dependientes de las personas y que se puedan auto gestionar con información adquirida en tiempo real.

En esta memoria se plasman los conocimientos adquiridos en la carrera, mejorando la metodología actual en desarrollo de firmware, diseño electrónico y gestión de proyectos.
