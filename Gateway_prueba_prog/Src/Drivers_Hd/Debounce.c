...
#include "../Inc/Drivers_Hd/Debounce.h"
/*
 =================================================================================================
 ...
 */
/*
 * Funciï¿½n: Debounce_Init
 * --------------------------
 *
 * PtrDataStruct: Especifica datos del retardo, antirebote y estado del botï¿½n
 * 
 * DebounceTick: Especifica el tiempo del retardo para el antirebote  de acuerdo al tiempo de ejecuciï¿½n de Debounce_Update()
 *		Ej:
 ...
 */
/**
 * Funciï¿½n: Debounce_Update
 * ----------------------------
 *
 * PtrDataStruct: Especifica datos del retardo, antirebote, estado del boton, la función modifica por referencia FlagFalling o FlagRising
 *
